...
public class HandlerClassDatabase implements Runnable {
	  ...
	  public HandlerClassDatabase(Socket clienteSocket, MainClassDatabase server) throws IOException {
	    this.clienteSocket = clienteSocket; 
	    this.server = server;
	  	this.in = new Scanner(clienteSocket.getInputStream()); // Criando o BufferedReader InputStream para receber do cliente 
